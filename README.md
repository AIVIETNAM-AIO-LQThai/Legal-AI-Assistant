# RAGuru — Vietnamese SME Legal RAG Notebook

RAGuru is a notebook-based legal retrieval and question answering pipeline for the **Road to AI 2026 (R2AI) — Build AI Legal Assistant** challenge.  
It is designed to answer Vietnamese SME legal questions by parsing legal PDFs, retrieving the most relevant legal articles, and generating a grounded submission file with legal citations.

The project is intentionally structured as a **single reproducible notebook pipeline**, rather than a web application. Its main output is a competition-style JSON/ZIP submission containing:
...
The notebook is designed so expensive optional runs, such as sample tests or full submission generation, are disabled by default until explicitly enabled.
